...
$verificaUsuario = mysqli_query($dbc,$query1) or die("<META HTTP-EQUIV=REFRESH CONTENT='0; URL=http://localhost/biblioteca/reserva.php'>
	<script type=\"text/javascript\">
	alert(\"Ocorreu um problema.\");
       </script>");
 $verificaLivro = mysqli_query($dbc,$query1) or die("<META HTTP-EQUIV=REFRESH CONTENT='0; URL=http://localhost/biblioteca/reserva.php'>
 <script type=\"text/javascript\">
 alert(\"Ocorreu um problema.\");
</script>");
